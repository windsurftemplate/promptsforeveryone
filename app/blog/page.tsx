  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black to-gray-900">
      <div className="max-w-7xl mx-auto px-4 pt-24 pb-16">
        ...
        >
          <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-[#00ffff] via-purple-500 to-pink-500 bg-clip-text text-transparent">
            Insights & Stories
          </h1>
              ...
              <div className="group relative h-[60vh] rounded-2xl overflow-hidden">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8 transform transition-transform group-hover:translate-y-2">
                  <div className="space-y-4">
                    ...
                    <h2 className="text-4xl md:text-5xl font-bold text-white group-hover:text-[#00ffff] transition-colors">
                      {featuredPost.title}
                    </h2>
                    ...
                    {featuredPost.tags && featuredPost.tags.length > 0 && (
                      <div className="flex flex-wrap gap-2">
                        {featuredPost.tags.map((tag) => (
                          <span
                            key={tag}
                            className="px-3 py-1 text-sm text-[#00ffff] bg-[#00ffff]/10 rounded-full"
                          >
                            {tag}
                          </span>
                        ))}
        ...
        >
          {remainingPosts.map((post, index) => (
            ...
            >
              <motion.article
                whileHover={{ y: -5 }}
                className="h-full backdrop-blur-sm rounded-xl overflow-hidden border border-gray-700/50 hover:border-[#00ffff]/50 transition-all relative"
              >
                <motion.div 
                  variants={gradientAnimation}
                  initial="initial"
                ...
                <div className="relative z-10 p-6 space-y-4">
                  ...
                  <h2 className="text-2xl font-bold text-white group-hover:text-[#00ffff] transition-colors">
                    {post.title}
                  </h2>
                  ...
                  {post.tags && post.tags.length > 0 && (
                    <div className="flex flex-wrap gap-2">
                      {post.tags.map((tag) => (
                        <span
                          key={tag}
                          className="px-2 py-1 text-xs text-[#00ffff] bg-[#00ffff]/10 rounded-full"
                        >
                          {tag}
                        </span>
                      ))}
