      ...
      <Card className="w-full max-w-md p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-center justify-between text-sm">
            <Link href="/forgot-password" className="text-primary-accent hover:text-primary-accent/80">
              Forgot password?
            </Link>
          </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-text-muted">
            ...
            <Link href="/signup" className="text-primary-accent hover:text-primary-accent/80">
              Sign up
            </Link>
          </p>
        </div>
