...
const toneOptions = [
  ...
  { id: 'humorous', name: 'Humorous', description: 'Light-hearted and fun' },
...
export default function TemplateGenerator() {
  ...
  // Update form data when template type changes
  const handleTypeChange = (type: typeof templateTypes[0]) => {
  ...
  // Update form data when tone changes
  const handleToneChange = (tone: typeof toneOptions[0]) => {
